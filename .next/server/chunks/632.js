...
/* unused harmony exports OrbitControls, MapControls */
...
class OrbitControls extends (/* unused pure expression or super */ null && (EventDispatcher)) {
...
class GLTFLoader extends (/* unused pure expression or super */ null && (Loader)) {
 ...
 * @pailhead
 */
class GLTFMeshStandardSGMaterial extends (/* unused pure expression or super */ null && (MeshStandardMaterial)) {
...
class GLTFCubicSplineInterpolant extends (/* unused pure expression or super */ null && (Interpolant)) {
...
class GLTFCubicSplineQuaternionInterpolant extends (/* unused pure expression or super */ null && (GLTFCubicSplineInterpolant)) {
